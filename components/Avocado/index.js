...
import {
  ...
  card__details__attributes,
  card__details__attributes__title,
  card__details__attributes__shape,
  card__details__attributes__shape__value,
  card__details__attributes__hardiness,
  card__details__attributes__hardiness__value,
  card__details__attributes__taste,
  card__details__attributes__taste__value,
  ...
  return (
    <div className={card}>
      ...
      <div className={card__details__attributes}>
        ...
        <p className={card__details__attributes__shape__value}>
          {avo.attributes.shape}
        </p>
        <p className={card__details__attributes__hardiness}>Hardiness</p>
        <p className={card__details__attributes__hardiness__value}>
          {avo.attributes.hardiness}
        </p>
        <p className={card__details__attributes__taste}>Taste</p>
        <p className={card__details__attributes__taste__value}>
          {avo.attributes.taste}
        </p>
      </div>
    </div>
  );
